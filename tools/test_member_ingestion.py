    ...
    def show_results(self):
        ...
        try:
            ...
            for sample in samples:
                district = f" (District {sample['district']})" if sample['district'] else ""
                print(f"  {sample['full_name']} - {sample['chamber'].title()} {sample['state']}{district} ({sample['party']})")
