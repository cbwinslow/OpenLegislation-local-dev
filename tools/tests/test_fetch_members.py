...
from tools.ingestion.congress.fetch_congress_members import (
    fetch_all_members,
    fetch_member_details,
    map_to_entity as map_congress_entity,
)
from tools.ingestion.members.fetch_govinfo_members import (
    download_bulk_zip,
    parse_members_xml,
    map_to_entity as map_govinfo_entity,
)
...
SAMPLE_CONGRESS_MEMBER_DETAILS = {
    "member": {
        ...
        "biography": {"dateOfBirth": "1950-11-23", "placeOfBirth": "Brooklyn, NY"},
