# -*- coding: utf-8 -*-
#
# Open Legislation documentation build configuration file, created by
...
latex_documents = [
    (
        "index",
        "OpenLegislation.tex",
        "Open Legislation Documentation",
        "NY State Senate Technology Services",
        "manual",
    ),
]
